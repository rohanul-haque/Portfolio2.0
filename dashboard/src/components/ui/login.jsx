...
export default function Login() {
  return (
    ...
    <div
      className="relative w-full flex items-center justify-center font-sans overflow-hidden p-4 bg-zinc-50 dark:bg-zinc-950">
      {/* Login Card. max-w-md ensures it doesn't get too wide on large screens, while w-full ensures it shrinks on small screens. */}
      <div
        className="relative w-full max-w-md p-8 sm:p-10 space-y-6 bg-white/80 dark:bg-zinc-900/60 backdrop-blur-xl rounded-2xl border border-zinc-200/50 dark:border-white/10 shadow-xl dark:shadow-2xl shadow-black/5 dark:shadow-black">
        ...
        {/* Footer links */}
        <div
          className="text-center text-sm text-zinc-600 dark:text-zinc-400 space-y-2">
          <p>
